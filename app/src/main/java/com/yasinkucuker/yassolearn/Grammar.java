...
public class Grammar extends AppCompatActivity {
    ...
    public void buttonCallGeminiAPI(View view){
        ...
        Content content =
                new Content.Builder().addText("Kullanıcının girdiği ingilizce dili grammar konusunu anlat ve örnekler ver. " +
                        "Eğer böyle bir grammar konusu yoksa uyarı ver. Kullanıcının girdiği konu : " + editText.getText().toString()).build();
