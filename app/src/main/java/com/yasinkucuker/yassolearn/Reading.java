...
public class Reading extends AppCompatActivity {
    ...
    public void buttonCallGeminiAPI(View view){
        ...
        Content content =
                new Content.Builder().addText("Kullanıcının girdiği sözcük veya cümleye göre ingilizce hikaye anlat ve önemli kelimeleri text'in altında " +
                        "türkçe karşılığı ile yaz. " +
